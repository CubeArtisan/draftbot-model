...
class PickGenerator(tf.keras.utils.Sequence):
    ...
    def __getitem__(self, idx):
        ...
        result = (self.cards_in_pack[context_idxs], self.picked[context_idxs], self.seen[context_idxs],
                  self.coords[context_idxs], self.coord_weights[context_idxs],
                  self.chosen_idx[context_idxs], self.y_idx[context_idxs])
        return (result, self.y_idx[context_idxs])
